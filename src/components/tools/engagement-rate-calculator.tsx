...
export function EngagementRateCalculator() {
  ...
  return (
    <GenericToolForm
      ...
      toolName="Instagram Engagement Rate Calculator"
      heroTitle="Instagram Engagement Rate Calculator (Posts/Reels)"
      heroDescription="Check engagement rates and performance signals for posts and Reels. Optimize your content strategy with data."
