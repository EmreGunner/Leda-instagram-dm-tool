...
import {
    RefreshCw, UserPlus, Users, CheckCircle2, Eye, X, Plus, Target
} from 'lucide-react';
        ...
        <>
            <div className="flex flex-col md:flex-row gap-4 mb-6">
                <div className="flex-1 space-y-4">
                    {/* Discovery Method */}
                    <div className="flex items-center gap-2 p-1 bg-background rounded-lg border border-border w-fit">
                        <button
                    ...
                    <div className="flex gap-2">
                        <div className="flex-1">
                            ...
                            <div className="flex gap-2 mb-2">
                                <button
                                    ...
                                    className={cn(
                                        ...
                                        searchType === 'hashtag' ? "bg-accent text-white" : "text-foreground-muted hover:bg-background-elevated"
                                    )}
                                >
                                    Hashtags
                                </button>
                                <button
                                    ...
                                    className={cn(
                                        "text-xs font-medium px-2 py-1 rounded transition-colors",
                                        searchType === 'username' ? "bg-accent text-white" : "text-foreground-muted hover:bg-background-elevated"
                                    )}
                                >
                                    User Followers
                                </button>
                            ...
                            <div className="flex gap-2">
                                <Input
                                    placeholder={searchType === 'hashtag' ? "#realestate" : "@username"}
                                    value={searchQuery}
